...
/*   Updated: 2024/09/22 12:23:50 by mohamibr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void check(char *input, t_env_cpy *env_cpy)
{
	...
	if (error_flag)
    {
        // A syntax error was detected; do not execute any commands
        if (token)
    ...
    // Check for unmatched quotes (you may need to implement check_for_quotations)
